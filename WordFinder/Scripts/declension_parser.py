...
def declension_parser(string):
    ...
    prepositional_singular = re.findall(u"(?u)\w+\,(?u)\w+ \(Творительный падеж единственного", string)[0].split()[0]
    ...
    print nominative_singular, genitive_singular, dative_singular, accusative_singular, prepositional_singular, instrumental_plural, nominative_plural, genitive_plural, dative_plural, accusative_plural, prepositional_plural, instrumental_plural